...
HD_PWD='U:/Year 2/computer Arch/TestProject_1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexer_tb.tcl
